...
int main()
{
    ...
    two_dimensional_array_input_elements (game_field,str,col,elements);
    two_dimensional_array_output (game_field,str,col);
    ...
    case 1:
        while (win_check==2)
        {
            x0_20x20_player_turn (game_field,str,col);
            ++counter;
            if (counter==400)
            {
                printf("\nВсе поле заполнено!\n");
            ...
            win_check=check_win_x0_5_20 (game_field,str,col);
            universalClear();
            two_dimensional_array_output (game_field,str,col);
                if (win_check==1)
                {
            ...
            two_dimensional_array_x0_reaction_20x20 (game_field,str,col);
            universalClear();
            two_dimensional_array_output (game_field,str,col);
            ++counter;
            win_check=check_win_x0_5_20 (game_field,str,col);
